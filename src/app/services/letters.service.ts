...
export class LettersService {
  ...
  createLetters(): void {
    ...
    // this.grid.cells[helloYOffset][helloXOffset + 21] = {value: 1};
    this.grid.cells[helloYOffset + 2][helloXOffset + 20] = {value: 1};
    this.grid.cells[helloYOffset + 3][helloXOffset + 20] = {value: 1};
    this.grid.cells[helloYOffset + 1][helloXOffset + 20] = {value: 1};

    // ,
    this.grid.cells[helloYOffset + 1][helloXOffset + 22] = {value: 1, options: {class: 'right-bottom-curved'}};
    ...
    // m
    this.grid.cells[helloYOffset + 1][helloXOffset + 27] = {value: 1, options: {class: 'left-top-curved'}};
    ...
    this.grid.cells[helloYOffset + 2][helloXOffset + 32] = {value: 1};
    this.grid.cells[helloYOffset + 2][helloXOffset + 31] = {value: 1};
    this.grid.cells[helloYOffset + 1][helloXOffset + 33] = {value: 1, options: {class: 'right-top-curved'}};
    this.grid.cells[helloYOffset + 2][helloXOffset + 33] = {value: 1};
    this.grid.cells[helloYOffset + 3][helloXOffset + 33] = {value: 1};
    this.grid.cells[helloYOffset + 2][helloXOffset + 29] = {value: 1};
    this.grid.cells[helloYOffset + 1][helloXOffset + 30] = {value: 1, options: {class: 'left-top-curved'}};
    this.grid.cells[helloYOffset + 2][helloXOffset + 30] = {value: 1};
    this.grid.cells[helloYOffset + 3][helloXOffset + 30] = {value: 1};
    ...
    // V
    this.grid.cells[nameYOffset][nameXOffset + 0] = {value: 1};
    this.grid.cells[nameYOffset + 1][nameXOffset + 1] = {value: 1};
    this.grid.cells[nameYOffset + 2][nameXOffset + 1] = {value: 1, options: {class: 'left-bottom-inclined'}};
    ...
    this.grid.cells[nameYOffset + 2][nameXOffset + 4] = {value: 1, options: {class: 'right-bottom-inclined'}};
    this.grid.cells[nameYOffset + 1][nameXOffset + 4] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 5] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 4] = {value: 1};

    // L
    this.grid.cells[nameYOffset][nameXOffset + 7] = {value: 1};
    this.grid.cells[nameYOffset + 1][nameXOffset + 7] = {value: 1};
    ...
    this.grid.cells[nameYOffset + 2][nameXOffset + 10] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 11] = {value: 1};
    ...
    this.grid.cells[nameYOffset][nameXOffset + 13] = {value: 1, options: {class: 'right-top-curved'}};

    // D
    this.grid.cells[nameYOffset][nameXOffset + 15] = {value: 1};
    this.grid.cells[nameYOffset + 1][nameXOffset + 15] = {value: 1};
    this.grid.cells[nameYOffset + 2][nameXOffset + 15] = {value: 1};
    this.grid.cells[nameYOffset + 2][nameXOffset + 16] = {value: 1};
    this.grid.cells[nameYOffset + 2][nameXOffset + 17] = {value: 1};
    this.grid.cells[nameYOffset + 2][nameXOffset + 18] = {value: 1, options: {class: 'right-bottom-curved'}};
    this.grid.cells[nameYOffset + 1][nameXOffset + 18] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 17] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 18] = {value: 1, options: {class: 'right-top-curved'}};
    ...
    this.grid.cells[nameYOffset + 1][nameXOffset + 21] = {value: 1};
    this.grid.cells[nameYOffset + 2][nameXOffset + 21] = {value: 1};

    // S
    this.grid.cells[nameYOffset][nameXOffset + 24] = {value: 1, options: {class: 'left-top-curved'}};
    this.grid.cells[nameYOffset + 1][nameXOffset + 25] = {value: 1, options: {class: 'right-top-curved'}};
    this.grid.cells[nameYOffset + 1][nameXOffset + 24] = {value: 1, options: {class: 'left-bottom-curved'}};
    this.grid.cells[nameYOffset + 2][nameXOffset + 23] = {value: 1, options: {class: 'left-bottom-curved'}};
    this.grid.cells[nameYOffset + 2][nameXOffset + 24] = {value: 1};
    this.grid.cells[nameYOffset + 2][nameXOffset + 25] = {value: 1, options: {class: 'right-bottom-curved'}};
    this.grid.cells[nameYOffset][nameXOffset + 25] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 26] = {value: 1, options: {class: 'right-top-curved'}};

    // L
    this.grid.cells[nameYOffset][nameXOffset + 28] = {value: 1};
    this.grid.cells[nameYOffset + 1][nameXOffset + 28] = {value: 1};
    this.grid.cells[nameYOffset + 1][nameXOffset + 28] = {value: 1};
    ...
    this.grid.cells[nameYOffset + 2][nameXOffset + 31] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 32] = {value: 1};
    ...
    this.grid.cells[nameYOffset][nameXOffset + 34] = {value: 1, options: {class: 'right-top-curved'}};

    // V
    this.grid.cells[nameYOffset][nameXOffset + 36] = {value: 1};
    this.grid.cells[nameYOffset + 1][nameXOffset + 37] = {value: 1};
    this.grid.cells[nameYOffset + 2][nameXOffset + 37] = {value: 1, options: {class: 'left-bottom-inclined'}};
    ...
    this.grid.cells[nameYOffset + 2][nameXOffset + 40] = {value: 1, options: {class: 'right-bottom-inclined'}};
    this.grid.cells[nameYOffset + 1][nameXOffset + 40] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 41] = {value: 1};
    this.grid.cells[nameYOffset][nameXOffset + 40] = {value: 1};
  }
}
